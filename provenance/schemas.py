...
class AttestationAccessGrantCreate(BaseModel):
    ...
    #: The existing attestation whose protected view is being shared.
    attestation_id: str = Field(..., min_length=1, max_length=80)
    #: An already-registered actor receiving read access.
...
class AttestationAccessGrantResponse(BaseModel):
    """Public grant view: the pair it authorizes and its creation time."""
