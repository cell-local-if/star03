...
class RevocationImpactImportNotFoundError(DomainError):
    status_code = 404
    code = "impact_import_not_found"
    message = "The requested impact import does not exist."

    def __init__(self, import_id: str):
        super().__init__(details={"import_id": import_id})


class RevocationImpactImportValidationError(DomainError):
