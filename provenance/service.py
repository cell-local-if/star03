...
# Global attestation access-grant-revocation search paging bounds.
...
def list_attestation_access_grant_revocations_page(
    ...
    """Return one grant-revocation page and the filtered total, both in SQL.
    ...
    reason is an empty result rather than a missing resource: records are
    selected by their own columns alone, never via a grant lookup.
