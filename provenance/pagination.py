...
#: Marker for cursors that page through the exchange-import receipt search.
...
def _validate_exchange_imports_claims(claims: dict[str, Any]) -> None:
    # The three receiving-identity filters are either absent (null) or
    # non-empty, exact-match strings.
