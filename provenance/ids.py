...
def attestation_revocation_id(
    ...
    """Return a stable ``rev_``-prefixed identifier for a revocation record.

    The identity is exactly the idempotency key: the revoked attestation, the
    revoking actor, and the reason. As with claims, the material is a
